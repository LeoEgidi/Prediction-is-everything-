...
\color{blue}
- sezione 2.1: da levare, in ogni caso da accorciare, magari usando qualche argomento lungo il paper. Al momento non ha molta ragione di esistere, e' un di piu. Si puo anche ricomprendere un po' nell' Introduzione.

- sezione 2.2: questa anche da levare, riutilizzando qualcosa. Forse la parte sul voto nel 2016 puo essere usata come esempio alla fine del paper.
\color{black}
...
\color{blue}
Questa  diventerebbe la nuova sezione 2, da riformulare. Probabilmente 3.1 si tiene, mentre 3.2 e 3.3 vanno ripensate e cambiate un po' di contenuti. 3.4 come e' al momento si toglie, e qualcosa si ricomprende da altre parti.
\color{black}
...
\color{blue}
Diventa section 3. Da rivedere 4.1 e modificare abbastanza, la 4.2 probabilmente molto da accorciare/cambiare.
\color{black}
...
\color{blue}
Diventa section 5. Da scrivere ex-novo.
\color{black}
