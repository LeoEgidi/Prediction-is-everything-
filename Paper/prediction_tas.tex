...
The role of prediction in science is still ambiguous, and even the modern statistical learning field could benefit from a deep investigation.  Is a method with a low predictive accuracy a bad method? Moreover, is a poor predictive accuracy able to falsify a posed theoretical model? Conversely, is a high predictive accuracy always constitutive of scientific success?  Statisticians argued a lot about the relationship/conflict existing between prediction and explanation: in this paper, we wish to overcome this conflict by proposing a practical behavioral protocol to warn about possible uses and abuses of the main forecasting practices and to reason in terms of transparency and falsification.
...
\noindent%
{\it Keywords:}  predictive accuracy; explanation; protocol; falsification.
\vfill
